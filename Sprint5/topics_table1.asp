...
<div align="center">
	<center>
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%">
			<tr>	
				<td width="20%" align="justify"><font face="Simplified Arabic" color="#0000ff"><b><%=rs1("subject")%>&nbsp;</b></font></td>
				
				<td width="20%" align="center"><font dir="ltr" face="Simplified Arabic"><a href="const.asp?id=<%=rs1("id")%>"><b>Delete</b></font></td><!--topic_del-->
			</tr>
			<tr>
